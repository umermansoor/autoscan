...
Your task is to convert the content of a PDF page into properly structured Markdown format. 
...
3. Do not exclude any content from the page during conversion such as footers, side notes, or captions. Capture everything.
